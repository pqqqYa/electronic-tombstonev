这是一个不需要登录的系统，所有的评论默认的reviewerName都是匿名用户
...
**mapperxml创建**
~~~txt
这是一个Springboot+Mybatis构建在线书城软件，包含了作家、书籍和评论信息

1. 实现作家信息的增加，删除，修改信息，查询信息
2. 实现书籍信息的增加，删除，修改信息，查询信息
3. 实现评论信息的增加，删除，修改信息，查询信息
