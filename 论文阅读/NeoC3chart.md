...
本作品在传统时间银行理念的基础上新加入区块链技术对传统服务器存储方式进行了替换，以基于PoS权益证明技术构建时间银行区块链私链，依托其中的智能合约，Hyperledger Besu分布式账本等子技术，搭配合理的节点节点服务器结构设计、响应式网页与微信小程序组成的用户友好交互界面构成了完整的时间银行管理系统，实现了登录注册，活动操作，管理审核，信息管理，社区培训以及时间币交易六大功能模块。
