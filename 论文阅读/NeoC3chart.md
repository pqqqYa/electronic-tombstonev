...
实现了用户进行注册、登录的功能。当用户忘记密码时，可通过手机验证码的方式重置密码。

2. 活动操作

用户填写活动的相关信息即可发布活动，在活动开始之间支持对活动修改或删除，修改后的活动将交至管理员再次审核。支持用户报名心仪的活动以及查看自己参加或发布的活动记录。

3. 管理审核

管理员需对用户的信息真实性、活动报名资格、活动发布资格进行审核，先经系统初步审核后交由管理员进一步确认审核结果，以图表的形式向管理员展示用户的相关信息。同时也需要审核活动的内容。

4. 信息管理

支持用户对个人信息进行修改；管理员能够在后台对用户信息进行修改、管理与维护。
...
当后双方确认无误后进行对应时间币的交易，在时间币账单中能够查看交易详细信息。
